...
//1637520/890697/2.49/4/4/Switch
...
(library Library_1
	...
	(patternDef "PTS647SN50SMTR2LFS" (originalName "PTS647SN50SMTR2LFS")
		(multiLayer
	...
	(symbolDef "PTS647SN50SMTR2LFS" (originalName "PTS647SN50SMTR2LFS")
	...
	(compDef "PTS647SN50SMTR2LFS" (originalName "PTS647SN50SMTR2LFS") (compHeader (numPins 4) (numParts 1) (refDesPrefix S)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PTS647SN50SMTR2LFS"))
		(attachedPattern (patternNum 1) (patternName "PTS647SN50SMTR2LFS")
			(numPads 4)
			(padPinMap
		...
		(attr "Mouser Part Number" "611-PTS647SN50SMTR2L")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/CK/PTS647SN50SMTR2LFS?qs=PqoDHHvF649f0IHjdDfo1A%3D%3D")
		(attr "Manufacturer_Name" "C & K COMPONENTS")
		(attr "Manufacturer_Part_Number" "PTS647SN50SMTR2LFS")
		(attr "Description" "Tactile Switches 50mA 12VDC, 1.0N 5.0mm H, G leads")
		(attr "<Hyperlink>" "https://www.ckswitches.com/media/2567/pts647.pdf")
		(attr "<Component Height>" "5")
		(attr "<STEP Filename>" "PTS647SN50SMTR2LFS.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=1.3")
